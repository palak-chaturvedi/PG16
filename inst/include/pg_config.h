...
#define CONFIGURE_ARGS " '--with-zlib' '--enable-debug' '--enable-depend' '--prefix=/home/azuredb/pg/pg2/postgres/inst/' '--enable-cassert' '--enable-tap-tests' '--with-readline' '--with-perl' 'CPPFLAGS=-DLOCK_DEBUG' '--with-libxml' '--with-openssl' 'CFLAGS=-ggdb3'"
